  ...
  export default {
    ...
    methods: {
      ...
      getPrice () {
        ...
        this.$http.post('https://easy-mock.com/mock/5a5dce8524f2fc35a9bf568b/example_1516097157361/getPrice', reqParams)
          .then((res) => {
      ...
      confirmBuy () {
        ...
        this.$http.post('https://easy-mock.com/mock/5a5dce8524f2fc35a9bf568b/example_1516097157361/createOrder', reqParams)
          .then((res) => {
